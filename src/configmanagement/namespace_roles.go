...
func (mgmt *K8sConfigManagementNamespaceRoles) listConfigItems() (map[string]config.ConfigObject) {
...
func (mgmt *K8sConfigManagementNamespaceRoles) deepCloneObject(configItem, k8sItem runtime.Object) (*runtime.Object) {
	configItem.(*v13.Role).DeepCopyInto(k8sItem.(*v13.Role))
	return &k8sItem
}
...
func (mgmt *K8sConfigManagementNamespaceRoles) handleDelete(k8sItem runtime.Object) (error) {
	err := mgmt.K8sService.Roles().Delete(mgmt.Namespace.Name, k8sItem.(*v13.Role).Name)
	return err
}
