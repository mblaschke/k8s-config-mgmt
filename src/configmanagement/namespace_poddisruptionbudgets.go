...
func (mgmt *K8sConfigManagementNamespacePodDisruptionBudgets) listConfigItems() (map[string]config.ConfigObject) {
...
func (mgmt *K8sConfigManagementNamespacePodDisruptionBudgets) deepCloneObject(configItem, k8sItem runtime.Object) (*runtime.Object) {
	configItem.(*v1beta1.PodDisruptionBudget).DeepCopyInto(k8sItem.(*v1beta1.PodDisruptionBudget))
	return &k8sItem
}
...
func (mgmt *K8sConfigManagementNamespacePodDisruptionBudgets) handleDelete(k8sItem runtime.Object) (error) {
	err := mgmt.K8sService.PodDisruptionBudgets().Delete(mgmt.Namespace.Name, k8sItem.(*v1beta1.PodDisruptionBudget).Name)
	return err
}
