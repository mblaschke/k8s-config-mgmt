...
func (mgmt *K8sConfigManagementNamespaceRoleBindings) listConfigItems() (map[string]config.ConfigObject) {
...
func (mgmt *K8sConfigManagementNamespaceRoleBindings) deepCloneObject(configItem, k8sItem runtime.Object) (*runtime.Object) {
	configItem.(*v13.RoleBinding).DeepCopyInto(k8sItem.(*v13.RoleBinding))
	return &k8sItem
}
...
func (mgmt *K8sConfigManagementNamespaceRoleBindings) handleDelete(k8sItem runtime.Object) (error) {
	err := mgmt.K8sService.RoleBindings().Delete(mgmt.Namespace.Name, k8sItem.(*v13.RoleBinding).Name)
	return err
}
