...
func (mgmt *K8sConfigManagementNamespacePodPresets) listConfigItems() (map[string]config.ConfigObject) {
...
func (mgmt *K8sConfigManagementNamespacePodPresets) deepCloneObject(configItem, k8sItem runtime.Object) (*runtime.Object) {
	configItem.(*v1alpha1.PodPreset).DeepCopyInto(k8sItem.(*v1alpha1.PodPreset))
	return &k8sItem
}
...
func (mgmt *K8sConfigManagementNamespacePodPresets) handleDelete(k8sItem runtime.Object) (error) {
	err := mgmt.K8sService.PodPresets().Delete(mgmt.Namespace.Name, k8sItem.(*v1alpha1.PodPreset).Name)
	return err
}
