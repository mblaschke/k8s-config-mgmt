...
func (mgmt *K8sConfigManagementNamespaceLimitRanges) listConfigItems() (map[string]config.ConfigObject) {
...
func (mgmt *K8sConfigManagementNamespaceLimitRanges) deepCloneObject(configItem, k8sItem runtime.Object) (*runtime.Object) {
	configItem.(*v1.LimitRange).DeepCopyInto(k8sItem.(*v1.LimitRange))
	return &k8sItem
}
...
func (mgmt *K8sConfigManagementNamespaceLimitRanges) handleDelete(k8sItem runtime.Object) (error) {
	err := mgmt.K8sService.LimitRanges().Delete(mgmt.Namespace.Name, k8sItem.(*v1.LimitRange).Name)
	return err
}
